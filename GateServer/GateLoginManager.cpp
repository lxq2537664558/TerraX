...
{
	REG_PACKET_HANDLER_ARG2(PktGameLoginReq, this, OnMessage_PktGameLoginReq);
	REG_PACKET_HANDLER_ARG2(PktEnterPermissionAck, this, OnMessage_PktEnterPermissionAck);
}
