...
GameServer::GameServer()
{
	...
	PacketDispatcher::GetInstance().RegPacketHandler<PktRegisterServer>(new PacketFunctor<PktRegisterServer>(
		std::bind(&GameServer::OnMessage_RegisterRet, this, std::placeholders::_1, std::placeholders::_2)));
}
...
void GameServer::OnMessage_RegisterRet(NetChannel& channel, PktRegisterServer& pkt)
{
