...
NetServer::NetServer(EventLoop* loop, int port, uint16_t max_conns)
    : m_evListener(evconnlistener_new_bind(loop->eventBase(), NewConnectionCallback, this,
...
void NetServer::NewConnectionCallback(struct evconnlistener* listener, evutil_socket_t fd,
